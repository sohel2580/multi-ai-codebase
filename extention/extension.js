...
/**
 * AgentCouncil Extension — extension.js
...
function writeStatus(status) {
  ...
  try {
    const data = {
      ...status,
      _updatedBy: 'Multi-AI Extension v1.0.0',
  ...
  try {
    ...
    staleCheckInterval = setInterval(() => {
      try {
        ...
        if (data.isBusy && data._ts && (Date.now() - new Date(data._ts).getTime()) > 45000) {
          writeStandby();
        }
      } catch (e) {}
    }, 1000);
...
<body>
  <div class="topbar">
    <div class="topbar-left">
      ...
      <div><span class="title-text">AgentCouncil — Multi-AI Parallel Council</span><span class="ver" id="top-ver-title">v1.5.9 — ${d && d.totalModelsOnline ? d.totalModelsOnline : "89"} AI Enterprise Edition</span></div>
    </div>
  ...
  <div class="stage" id="stage">
    ...
    <div class="agent" id="ag-deepseek"><div class="bubble" id="b-deepseek"></div><div class="agent-emoji">🧠</div><div class="agent-name" id="nm-deepseek">agnes-2.5-flash</div><div class="agent-role" id="rl-deepseek">DeepSeek / Agnes</div><div class="agent-badge" id="bd-deepseek">Standby</div><div class="squad-count" id="sq-deepseek">👥 ${d && d.squadCounts && d.squadCounts.deepseek ? d.squadCounts.deepseek : "15"} AI Models</div></div>
    <div class="agent" id="ag-qwen"><div class="bubble" id="b-qwen"></div><div class="agent-emoji">⚡</div><div class="agent-name" id="nm-qwen">qwen3.6-27b</div><div class="agent-role" id="rl-qwen">Qwen 2.5 Coder (Groq)</div><div class="agent-badge" id="bd-qwen">Standby</div><div class="squad-count" id="sq-qwen">👥 ${d && d.squadCounts && d.squadCounts.qwen ? d.squadCounts.qwen : "25"} AI Models</div></div>
    <div class="agent" id="ag-llama"><div class="bubble" id="b-llama"></div><div class="agent-emoji">🛡️</div><div class="agent-name" id="nm-llama">gpt-oss-120b</div><div class="agent-role" id="rl-llama">Llama / OSS Shield</div><div class="agent-badge" id="bd-llama">Standby</div><div class="squad-count" id="sq-llama">👥 ${d && d.squadCounts && d.squadCounts.llama ? d.squadCounts.llama : "12"} AI Models</div></div>
    <div class="agent" id="ag-gemma"><div class="bubble" id="b-gemma"></div><div class="agent-emoji">🧪</div><div class="agent-name" id="nm-gemma">nemotron-3.5:free</div><div class="agent-role" id="rl-gemma">Nvidia Nemotron</div><div class="agent-badge" id="bd-gemma">Standby</div><div class="squad-count" id="sq-gemma">👥 ${d && d.squadCounts && d.squadCounts.gemma ? d.squadCounts.gemma : "14"} AI Models</div></div>
    <div class="agent" id="ag-claude"><div class="bubble" id="b-claude"></div><div class="agent-emoji">⚖️</div><div class="agent-name" id="nm-claude">agnes-2.5-judge</div><div class="agent-role" id="rl-claude">Executive Judge</div><div class="agent-badge" id="bd-claude">Standby</div><div class="squad-count" id="sq-claude">👥 ${d && d.squadCounts && d.squadCounts.claude ? d.squadCounts.claude : "11"} AI Models</div></div>
    <div class="agent" id="ag-seo"><div class="bubble" id="b-seo"></div><div class="agent-emoji">📈</div><div class="agent-name" id="nm-seo">north-mini-code:free</div><div class="agent-role" id="rl-seo">Cohere & Mistral</div><div class="agent-badge" id="bd-seo">Standby</div><div class="squad-count" id="sq-seo">👥 ${d && d.squadCounts && d.squadCounts.seo ? d.squadCounts.seo : "12"} AI Models</div></div>
  </div>

  <div class="ticker"><span class="ticker-lbl">► LIVE</span><span class="ticker-txt" id="tickerTxt">Real Multi-AI Agentic Engine · ${d && d.totalModelsOnline ? d.totalModelsOnline : "89"} AI Swarm Ready</span></div>
...
(function(){
  ...
  function render(d){
    ...
    if(tt)tt.textContent=d.taskTitle||'Real Multi-AI Agentic Engine · v1.0.0 Ready';
...
function activate(context) {
  try {
    ...
    console.log('[AgentCouncil v1.0.0] Real Agentic Engine activated.');
  } catch (err) {
